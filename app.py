...
def load_css():
    ...
    /* Enhanced typography and text visibility */
    * {
        color: #1a1a1a !important;
        font-family: 'Inter', -apple-system, BlinkMacSystemFont, sans-serif !important;
    }
    
    /* Page background with dynamic gradient */
    .stApp {
    ...
    /* Premium metric cards with 3D effect */
    .metric-card {
    ...
    .dashboard-header {
        background: linear-gradient(135deg, #667eea 0%, #764ba2 25%, #6b73ff 50%, #9068be 75%, #764ba2 100%) !important;
    ...
    .dashboard-header::before {
        ...
        width: 100%;
        height: 100%;
        background: url('data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><circle cx="20" cy="20" r="2" fill="white" opacity="0.3"><animate attributeName="opacity" values="0.3;0.8;0.3" dur="2s" repeatCount="indefinite"/></circle><circle cx="80" cy="30" r="1.5" fill="white" opacity="0.4"><animate attributeName="opacity" values="0.4;0.9;0.4" dur="1.5s" repeatCount="indefinite"/></circle><circle cx="60" cy="70" r="2.5" fill="white" opacity="0.2"><animate attributeName="opacity" values="0.2;0.7;0.2" dur="3s" repeatCount="indefinite"/></circle></svg>') !important;
        opacity: 0.6;
    }
    ...
    .upload-area {
        ...
        backdrop-filter: blur(20px) !important;
        border: 3px dashed rgba(102, 126, 234, 0.5) !important;
        border-radius: 25px !important;
    ...
    .stMarkdown, .stText, .stWrite, .stDataFrame {
        color: #1a202c !important;
    }
    ...
    /* Enhanced micro-interactions and particle effects */
    ...
    /* Final touch - breathing animation for important elements */
    .dashboard-header {
        animation: gradientShift 8s ease infinite, breathe 4s ease-in-out infinite !important;
    }
